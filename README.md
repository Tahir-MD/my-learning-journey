...
| # | Certificate | Date Completed | Key Skills |
|---|-------------|----------------|-------------|
| 1 | Google Cybersecurity | Oct 2024 | Python, Linux, SQL, SIEM, IDS |
| 2 | Google Digital Marketing & E-commerce | Oct 2024 | Email marketing, analytics, customer loyalty |
| 3 | Google IT Automation with Python | Aug 2025 | Python, Git, GitHub, cloud automation |
| 4 | Google Advanced Data Analytics | May 2026 | Machine learning, predictive modeling, regression |
| 5 | Google AI | May 2026 | AI prompting, content creation, data analysis, coding |
| 6 | Google UX Design | May 2026 | Wireframing, Figma, prototyping, user research |
...
- [Google AI](https://coursera.org/verify/professional-cert/KYD6CWODE9F4)
- [Google UX Design](https://coursera.org/verify/professional-cert/YUJIBDJBRCRK)
- [Google Prompting Essentials](https://coursera.org/verify/specializaton/WMKWCVEK0I35)
- [Google IT Automation with Python](https://coursera.org/verify/professional-cert/MKOW7OAHHRPR)
- [Google Cybersecurity](https://coursera.org/verify/professional-cert/QNSFG3B73Z6Y)
- [Google AI Essentials](https://coursera.org/verify/specialization/EF1GAGICBRDN)
